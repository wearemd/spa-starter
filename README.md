...
## 🚀 Cache busting
Cache busting in this starter is done by automatically appending a hash to each asset filename. You can read more about it on the [Webpack documentation](https://webpack.js.org/guides/caching/).
